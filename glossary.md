...
| to identify         | müəyyənləşdirmək (tapmaq)       |
| to identify         | təsbit etmək (nəticə yönümlü)   |
| identification      | müəyyənləşdirmə/təsbit          | 
| authentication      | kimliyin doğrulanması           |
...
| to assign           | təhkim etmək/vermək/mənimsətmək |
| assigment           | təhkim/vermə/mənimsətmə         |
| to define (konsept) | tərif(ini) vermək               |
| to define (texniki) | təyin etmək                     |
| definition          | tərif(i)                        |
| definite            | qəti                            |
| definitive          | qəti                            |
| to specify          | qeyd etmək, göstərmək           |
| to determine        | müəyyən etmək                   |
| to detect           | aşkarlamaq/təsbit etmək         |
